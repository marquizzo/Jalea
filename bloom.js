...
pc.extend(pc, function () {
	...
	/**
	 * @name pc.BloomPostEffect
	 * @class Implements the BloomPostEffect post processing effect
	 * @constructor Creates new instance of BloomPostEffect
	 * @extends pc.PostEffect
	 * @param {app.graphicsDevice} graphicsDevice The graphics device of the application
	 * @property {Number} bloomThreshold Only pixels brighter than this threshold will be processed. Ranges from 0 to 1
	 * @property {Number} blurAmount Controls the amount of blurring.
	 * @property {Number} bloomIntensity The intensity of the effect.
	 */
	var BloomPostEffect = function (graphicsDevice) {
		// Shaders
		var attributes = {
    ...
    BloomPostEffect = pc.inherits(BloomPostEffect, pc.PostEffect);

    BloomPostEffect.prototype = pc.extend(BloomPostEffect.prototype, {
...
BloomScript.attributes.add('bloomIntensity', { 
	type: 'number', 
...
// Only pixels brighter than this threshold will be processed. Ranges from 0 to 1
BloomScript.attributes.add('bloomThreshold', { 
	type: 'number', 
...
BloomScript.attributes.add('blurAmount', { 
	type: 'number', 
	title: 'Blur Amount', 
	min: 1,
	max: 10,
...
// Initialize BloomScript, not to be confused with BloomPostEffect
BloomScript.prototype.initialize = function() {
	this.effect = new pc.BloomPostEffect(this.app.graphicsDevice);
